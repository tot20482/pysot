...
class ModelBuilder(nn.Module):
    ...
    def forward(self, data):
        ...
        # Lấy device của model, CPU hoặc GPU
        ...
        zf_all = self.backbone(templates_flat)
        ...
        if isinstance(zf_all, list):
            ...
            zf = zf_all.view(B, N, *zf_all.shape[1:]).mean(dim=1)
        ...
        if cfg.MASK.MASK:
            ...
            mask_loss = None  # hoặc tính mask_loss nếu có
